...
Connection setup contains no credentials.  A live session proves only that an MCP
client process is connected; it confers no admission, review, signing, merge, or
...
def instructions(repo: str, *, name: str, purpose: str,
                 runtime: str, executable: str = "admissible") -> dict[str, Any]:
