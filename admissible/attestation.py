...
* ``ADMISSIBLE_HMAC_KEY``       -- signs admissions (:mod:`admissible.receipt`);
* ``ADMISSIBLE_REVIEW_KEY``     -- signs reviews (:mod:`admissible.review`);
...
from .fsutil import SecretFileError, read_secret_file
...
def admissible_source_conclusions(readiness: object) -> frozenset[str]:
    ...
    from .decision import (READINESS_AWAITING_REVIEW, READINESS_NOT_READY,
...
def evaluation_state_readiness(state: object, readiness: object
    ...
    from .decision import (BLOCKED, CHECKS_PASSED, READINESS,
...
def attest_preview(preview: object, *, key_id: str, secret: bytes,
    ...
    from .decision import digest_of_document
