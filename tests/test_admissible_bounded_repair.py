...
class DiscoveredCountsTest(unittest.TestCase):
    ...
    def test_the_research_kernel_count_is_what_the_paper_cites(self):
        # 587 is the number the paper cites, and the kernel scope is where a
        ...
        self.assertEqual(kernel + 37 + 71, 587)
        self.assertIn("| Research kernel — the number the paper cites | 587 |",
                      self.readme)
