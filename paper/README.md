...
4. [`custody/DRAFT.md`](custody/DRAFT.md) — *Custody theory*: the mathematics
   ...
   the record of its six review rounds (three adversarial referee rounds, the pull request's automated review, and two seven-referee re-reviews of the pull request head) is [`custody/REVIEWS.md`](custody/REVIEWS.md).
