...
4. [`custody/DRAFT.md`](custody/DRAFT.md) — *Custody theory*: the mathematics
   ...
   the record of its four review rounds (three adversarial referee rounds and the pull request's automated review) is [`custody/REVIEWS.md`](custody/REVIEWS.md).
