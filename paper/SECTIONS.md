...
| Counts (measured) | 594 checks green: 486 `tests/` + 37 atlas + 71 cockpit; 43 per-guard deletion proofs + 2 joint; 2 citation binders |
...
| Tests | 594 repository checks total: 486 Python kernel/server/context/RGA/calibration/paper/custody + 37 atlas/protocol + 71 cockpit |
