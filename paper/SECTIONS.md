...
| Counts (measured) | 669 checks green: 561 `tests/` + 37 atlas + 71 cockpit; 43 per-guard deletion proofs + 2 joint; 2 citation binders |
...
| Tests | 669 repository checks total: 561 Python kernel/server/context/RGA/calibration/paper/custody + 37 atlas/protocol + 71 cockpit |
