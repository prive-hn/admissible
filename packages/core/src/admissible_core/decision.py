...
# says, and only the receipt-issuing authority ever writes ``ADMITTED``.
...
def _in_attempt(record, attempt_id: str) -> bool:
    ...
    :func:`admissible_core.evidence.reuse_in_attempt`), which leaves the
...
def evaluate(*, artifact_class: ArtifactClass, repository: str,
    ...
    derived into it by :func:`admissible_core.evidence.reuse_in_attempt`,
