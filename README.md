...
| `tests/` | 2976 kernel/server/context/project/class/RGA/calibration/bench/schema/paper/custody tests, including 2451 for the developer product |
...
3084 checks green in this repository, in two scopes that are counted
separately because they prove different things:

| Scope | Checks | Where |
| ----- | -----: | ----- |
| Research kernel — the number the paper cites | 633 | 525 in `tests/` + 37 `atlas/tests/` + 71 `apps/cockpit/tests/` |
...
| **Total** | **3084** | 2976 under `tests/`, 37 atlas, 71 cockpit |
