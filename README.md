...
| `tests/` | 2878 kernel/server/context/project/class/RGA/calibration/bench/schema/paper tests, including 2445 for the developer product |
...
2986 checks green in this repository, in two scopes that are counted
...
| **Total** | **2986** | 2878 under `tests/`, 37 atlas, 71 cockpit |
