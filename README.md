...
| `tests/` | 2875 kernel/server/context/project/class/RGA/calibration/bench/schema/paper tests, including 2442 for the developer product |
...
2983 checks green in this repository, in two scopes that are counted
...
| **Total** | **2983** | 2875 under `tests/`, 37 atlas, 71 cockpit |
