...
| `tests/` | 2879 kernel/server/context/project/class/RGA/calibration/bench/schema/paper tests, including 2446 for the developer product |
...
2987 checks green in this repository, in two scopes that are counted
...
| Developer product (`admissible/`) | 2446 | `tests/test_admissible_*.py` + the split suites under `tests/architecture/`, `tests/core/`, `tests/ready/`, `tests/trust/` and `tests/compatibility/` |
| **Total** | **2987** | 2879 under `tests/`, 37 atlas, 71 cockpit |
